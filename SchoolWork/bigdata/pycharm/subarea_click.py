...
file = r".\little_area_heat_info.txt"
...
area_df.write.jdbc("jdbc:mysql://localhost:3306/bilibili?serverTimezone=UTC&useSSL=false", 'subarea_click', 'overwrite', conn_param)
